...
export const teams: Record<string, Team> = {
  rm: team("rm", "Real Madrid", "RMA", "https://api.dicebear.com/7.x/initials/svg?seed=RM", "football", "Spain", { city: "Madrid", founded: 1902, coach: "Carlo Ancelotti", stadium: "Santiago Bernabéu", capacity: 81044 }),
  bay: team("bay", "Bayern Munich", "FCB", "https://api.dicebear.com/7.x/initials/svg?seed=FCB", "football", "Germany", { city: "Munich", founded: 1900, coach: "Thomas Tuchel", stadium: "Allianz Arena", capacity: 75000 }),
  bar: team("bar", "Barcelona", "BAR", "https://api.dicebear.com/7.x/initials/svg?seed=BAR", "football", "Spain", { city: "Barcelona", founded: 1899, coach: "Xavi Hernández", stadium: "Camp Nou", capacity: 99354 }),
  mci: team("mci", "Man City", "MCI", "https://api.dicebear.com/7.x/initials/svg?seed=MCI", "football", "England", { city: "Manchester", founded: 1880, coach: "Pep Guardiola", stadium: "Etihad Stadium", capacity: 53400 }),
  ars: team("ars", "Arsenal", "ARS", "https://api.dicebear.com/7.x/initials/svg?seed=ARS", "football", "England", { city: "London", founded: 1886, coach: "Mikel Arteta", stadium: "Emirates Stadium", capacity: 60704 }),
  liv: team("liv", "Liverpool", "LIV", "https://api.dicebear.com/7.x/initials/svg?seed=LIV", "football", "England", { city: "Liverpool", founded: 1892, coach: "Jürgen Klopp", stadium: "Anfield", capacity: 61112 }),
  gir: team("gir", "Girona", "GIR", "https://api.dicebear.com/7.x/initials/svg?seed=GIR", "football", "Spain", { city: "Girona", founded: 1930, stadium: "Estadi Montilivi", capacity: 13286 }),
  atl: team("atl", "Atlético Madrid", "ATM", "https://api.dicebear.com/7.x/initials/svg?seed=ATM", "football", "Spain", { city: "Madrid", founded: 1903, stadium: "Metropolitano", capacity: 68456 }),
  ath: team("ath", "Athletic Club", "ATH", "https://api.dicebear.com/7.x/initials/svg?seed=ATH", "football", "Spain", { city: "Bilbao", founded: 1898, stadium: "San Mamés", capacity: 53289 }),
  ind: team("ind", "India", "IND", "https://api.dicebear.com/7.x/initials/svg?seed=IND", "cricket", "India", { coach: "Rahul Dravid" }),
  aus: team("aus", "Australia", "AUS", "https://api.dicebear.com/7.x/initials/svg?seed=AUS", "cricket", "Australia", { coach: "Andrew McDonald" }),
  eng: team("eng", "England", "ENG", "https://api.dicebear.com/7.x/initials/svg?seed=ENG", "cricket", "England", { coach: "Brendon McCullum" }),
  mi: team("mi", "Mumbai Indians", "MI", "https://api.dicebear.com/7.x/initials/svg?seed=MI", "cricket", "India", { city: "Mumbai" }),
  csk: team("csk", "Chennai Super Kings", "CSK", "https://api.dicebear.com/7.x/initials/svg?seed=CSK", "cricket", "India", { city: "Chennai" }),
  rcb: team("rcb", "Royal Challengers", "RCB", "https://api.dicebear.com/7.x/initials/svg?seed=RCB", "cricket", "India", { city: "Bengaluru" }),
