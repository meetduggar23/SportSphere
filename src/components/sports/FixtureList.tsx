...
<div className="flex items-center gap-2.5">
                ...
                <span className="truncate text-sm font-medium text-foreground-soft">{fixture.homeTeam.name}</span>
                {fixture.awayTeam && (
                  <>
                    <span className="shrink-0 text-xs text-muted">vs</span>
                    <span className="truncate text-sm font-medium text-foreground-soft">{fixture.awayTeam.name}</span>
